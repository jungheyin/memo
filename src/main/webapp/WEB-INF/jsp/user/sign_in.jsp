...
<div> 
	...
	<form id="loginForm" action="/user/sign_in" method="post" >
		<input type="text" name="id" id="loginId"class="form-control mb-2"
			 placeholder="ID">
		<input type="password" name="password" id="password" class="form-control mb-3"
			placeholder="PASSWORD">
			
		<input type="submit" class="btn btn-block mb-2" vlaue="로그인">
		<br>
		
		<a href="/user/sign_up_view" class="btn btn-blok w-100">회원가입</a>
	</form>
